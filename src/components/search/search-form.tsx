          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <Label htmlFor="query" className="text-xl font-bold heading gradient-text">Research Topic</Label>
              </div>
              ...
              <div className="relative group">
                <Input
                  ...
                  className="h-16 text-lg pl-12 pr-20 rounded-xl border-border/60 bg-background/80 backdrop-blur-sm focus:bg-background focus:ring-2 focus:ring-primary/30 focus:border-primary/50 transition-all duration-300 group-hover:border-primary/30 input-modern"
                  required
                />
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <svg 
                  className={`w-4 h-4 transition-transform duration-300 text-primary ${showAdvanced ? 'rotate-180' : ''}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
            ...
            {showAdvanced && (
              <div className="fade-in space-y-6 p-6 glass-subtle rounded-xl border border-border/30 relative overflow-hidden advanced-filters">
                {/* Panel decoration */}
                <div className="absolute -top-12 -right-12 w-24 h-24 gradient-mesh rounded-full blur-2xl opacity-10"></div>
                
                <div className="relative">
                  <h3 className="text-lg font-semibold heading gradient-text mb-6">Advanced Search Options</h3>
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4">
                     ...
                     <div className="space-y-4">
                       ...
                       <label className="group flex items-center space-x-3 p-4 rounded-lg bg-background/70 border border-border/40 cursor-pointer hover:bg-background/90 hover:border-primary/30 transition-all duration-300 interactive">
                         <input
                           id="openAccess"
                           type="checkbox"
            ...
            <div className="relative">
              <Button 
                ...
                className="w-full h-16 text-lg font-bold rounded-xl gradient-primary hover:glow-hover transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
              >
