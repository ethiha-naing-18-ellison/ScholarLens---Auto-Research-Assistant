          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-8 lg:space-y-0">
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <h2 className="text-2xl md:text-3xl font-bold heading">
              ...
              <div className="flex items-center space-x-8 text-muted-foreground">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-semibold text-base">{results.length} papers found</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="font-semibold text-base">{selectedPapers.size} selected</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <Button 
                ...
                disabled={selectedPapers.size === 0}
                className="px-6 py-3 rounded-xl gradient-primary hover:glow-hover transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden"
              >
                ...
                <div className="relative flex items-center space-x-2">
                  ...
                  <span className="font-semibold text-base">Generate Report</span>
            ...
            <div className="space-y-6 pr-12">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                  {paper.year && (
                    <div className="flex items-center space-x-2 px-3 py-1 glass-subtle rounded-lg">
              ...
              <div className="flex flex-wrap gap-2">
                <span className={`inline-flex items-center px-3 py-1 rounded-lg text-xs font-semibold border transition-all duration-300 hover:scale-105 ${getSourceColor(paper.source)}`}>
                  {paper.source}
                </span>
                
                {paper.isOpenAccess && (
                  <span className="inline-flex items-center px-3 py-1 rounded-lg text-xs font-semibold bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 transition-all duration-300 hover:scale-105">
                ...
                {paper.score && (
                  <span className="inline-flex items-center px-3 py-1 rounded-lg text-xs font-semibold bg-primary/20 text-primary border border-primary/30 transition-all duration-300 hover:scale-105">
                    <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-3 pt-4">
                {paper.url && (
                  <a
                    ...
                    className="group flex items-center space-x-2 px-3 py-2 bg-primary/10 hover:bg-primary/20 text-primary rounded-lg text-sm font-medium transition-all duration-300 interactive"
                  >
                    <svg className="w-4 h-4 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {paper.pdfUrl && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => e.stopPropagation()}
                    className="group flex items-center space-x-2 px-3 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 rounded-lg text-sm font-medium transition-all duration-300 interactive"
                  >
                    <svg className="w-4 h-4 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
